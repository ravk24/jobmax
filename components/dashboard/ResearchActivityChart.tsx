          ...
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <XAxis
                ...
                tick={AXIS_TICK}
              />
              {/* allowDecimals: the auto-scale otherwise offers fractional
                  ticks (0.75, 1.5…) when the max count is small — nonsense
                  for an integer count axis. Not a fixed domain. */}
              <YAxis
                width={36}
                axisLine={false}
                tickLine={false}
